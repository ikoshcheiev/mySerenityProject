...
public class AccountPage extends BasePage{
     ...
     * @return
     */
    public AccountPage addNewUserInformation(String userName, String password, String repeatPassword){
     ...
     * @return
     */
    public AccountPage addAccountInformation(String firstName,
                                             String lastName,
                                             String email,
                                             String phone,
                                             String addr1,
